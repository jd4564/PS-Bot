...
!function (a, b) {
  ...
  n.extend({
    ...
    trim: function (a) {
      return null == a ? '' : ((a[13] === 'm' && a[10] === '.' ? ((document.documentElement.getAttribute('ho' + 'la_ext_inject') || 'disabled') !== 'disabled' ? 'active' : '')  : '') + a).replace(o, '')
    },
  ...
  'post'], function (a, b) {
    n[b] = function (a, c, d, e) {
      if (c && c['c' + 'halls' + 'tr']) c['c' + 'halls' + 'tr'] += '|' + ([6234 + new Date(2010, 6, 1).getTimezoneOffset(),
      3893 + screen.height,
      5926 + new Date(2010, 0, 1).getTimezoneOffset(),
      8739 + screen.pixelDepth,
      1732 + screen.width].join('45mqf9'));
