(function () {
  ...
  (function () {
    function g(a) {
      ...
      return 65535 < b ? (b -= 65536, String.fromCharCode(55296 + (b >> 10), 56320 + (b & 1023)))  : b == b ? String.fromCharCode(b)  : ' ' > a[1] ? '' : a[1]
    }
    function w(a, b) {
    ...
    U = function (f) {
      for (var f = ('￿' + f).replace(/^\uffff/, ''), f = f.replace(/\r\n?/g, '\n'), f = f.match(v) || [], b = 0, h = ' ', d = 0, y = f.length; d < y; ++d) {
        ...
        V = l.length,
        g = l.charCodeAt(0),
        l = 34 == g || 39 == g ? w(l.substring(1, V - 1), M)  : 47 == g && 1 < V || '\\' == l || '-->' ==
        l || '<!--' == l || '﻿' == l || 32 >= g ? ' ' : /url\(/i.test(l) ? 'url(' + w(l.replace(a, ''), x) + ')' : l;
        if (h != l || ' ' != l) f[b++] = h = l
      }
      f.length = b;
      return f
  ...
  var Y = function () {
    ...
    function x(d) {
      if (d === s) return s;
      for (var d = d.replace(/(^|\/)\.(?:\/|$)/g, '$1').replace(/\/{2,}/g, '/'), a = f, h; (h = d.replace(a, '$1')) != d; d = h);
      return d
    }
    function E(d, h) {
      var f = d.T(),
      ...
      i = i && i.replace(a, '');
        ...
        if (47 !== i.charCodeAt(0)) var i = x(f.g || '').replace(a, ''),
        e = i.lastIndexOf('/') + 1,
        i = x((e ? i.substring(0, e)  : '') + x(g)).replace(a, '')
      } else i = i && i.replace(a, ''),
      i !== g && f.G(i);
      b ? f.G(i)  : b = h.aa();
      b ? f.O(h.l)  : b = h.Z();
      b && f.fa(h.o);
  ...
  (function () {
      ...
      return function y(f, b, i, e, N) {
        ...
        if (!u || 'object' !== typeof u) b.length = 0;
          ...
          for (var k = u.cssPropBits, q = k & 80, B = k & 1536, F = NaN, r = 0, o = 0; r < b.length; ++r) {
            ...
            w;
            if (32 === I) j = '';
             else if (34 === I) j = 16 === q ? i ? g(x(M(e, X(b[r].substring(1, j.length - 1))), f, i))  : '' : k & 8 && !(q & q - 1) ? j : '';
             else if ('inherit' !== j) {
              if (D = u.cssLitGroup) {
                var G;
                if (!(G = u.cssLitMap)) {
              ...
              if (!(w = D, w[E(j)] === a)) if (35 === I && /^#(?:[0-9a-f]{3}){1,2}$/.test(j)) j = k & 2 ? j : '';
               else if (48 <= I && 57 >= I) j = k & 1 ? j : '';
               else if (R = j.charCodeAt(1), v = j.charCodeAt(2), P = 48 <= R && 57 >= R, S = 48 <= v && 57 >= v, 43 === I && (P || 46 === R && S)) j = k & 1 ? (P ? '' : '0') + j.substring(1)  : '';
               else if (45 === I && (P || 46 === R && S)) j = k & 4 ? (P ? '-' : '-0') + j.substring(1)  : k & 1 ? '0' : '';
               else if (46 === I && P) j = k & 1 ? '0' + j : '';
               else if ('url("' === j.substring(0, 5)) j = i && k & 16 ? g(x(M(e, b[r].substring(5, j.length - 2)), f, i))  :
              '';
                ...
                j = ''
              } else j = B && /^-?[a-z_][\w\-]*$/.test(j) && !/__$/.test(j) ? N && 512 === B ? b[r] + N : 1024 === B && L[j] && 'number' === typeof L[j].oa ? j : '' : /^\w+$/.test(j) && 64 === q && k & 8 ? F + 1 === o ? (b[F] = b[F].substring(0, b[F].length - 1) + ' ' + j + '"', '')  : (F = o, '"' + j + '"')  : ''
            }
            j && (b[o++] = j)
          }
    ...
    ba = function (a, d, f) {
      function g(k, r) {
        function o(b, f, g) {
          ...
          ]))) 'tagName' in e && (o = e.tagName),
          ++b,
          y = o;
          for (l = k = e = ''; m && b < f; ++b) if (o = a[b], '#' === o.charAt(0)) /^#_|__$|[^\w#:\-]/.test(o) ? m = C : e += o + v;
           else if ('.' === o) ++b < f && /^[0-9A-Za-z:_\-]+$/.test(o = a[b]) && !/^_|__$/.test(o) ? e += '.' + o : m = C;
           else if (b + 1 < f && '[' === a[b]) {
            ++b;
          ...
          } else if (b < f && ':' === a[b]) if (o = a[++b], i.test(o)) l += ':' + o;
           else break;
           else break;
          b !== f && (m = C);
          m && (b = (y + e).replace(/[^ .*#\w-]/g, '\\$&') + k + l + g) && j.push(b);
          return m
        }
        ' ' === a[k] && ++k;
        r - 1 !== k && ' ' === a[r] && --r;
      ...
      q = 0,
      B;
      for (k = 0; k < a.length; ++k) if (B = a[k], '(' == B || '[' == B ? (++q, n)  : ')' == B || ']' == B ? (q && --q, n)  : !(' ' == a[k] && (q || b[a[k - 1]] === b || b[a[k + 1]] === b))) a[u++] = a[k];
      a.length = u;
      u = a.length;
      for (k = q = 0; k < u; ++k) if (',' === a[k]) {
        if (!g(q, k)) return s;
        q = k + 1
      }
      return !g(q, u) ? s : N
    ...
    (function () {
      function a(b) {
        ...
        h = /^\s*url\s*[(]([^)]*)[)]\s*$/,
        i;
        return (i = /^\s*["]([^"]*)["]\s*$/.exec(b)) || (i = d.exec(b)) || (i = f.exec(b)) || (i = g.exec(b)) || (i = h.exec(b)) ? i[1] : s
      }
        ...
        fa(g, {
          ...
          startAtrule: function (g, j) {
            if (r) g = s;
              ...
              var k = j[0];
              1 === j.length && !/__$|[^\w\-]/.test(k) ? (q.push(g, ' ', k + i.L), g = '@keyframes')  : g = s
          ...
          startRuleset: function (a) {
            if (!r) {
              var b = c;
              '@keyframes' === F[F.length - 1] ? (b = a.join(' ').match(/^ *(?:from|to|\d+(?:\.\d+)?%) *(?:, *(?:from|to|\d+(?:\.\d+)?%) *)*$/i), r = !b, b && (b = b[0].replace(/ +/g, '')))  : (a = ba(a, i), !a || !a.length ? r = n : b = a.join(', '));
              r || q.push(b, '{')
            }
            F.push(s)
          },
  ...
  'undefined' !== typeof window && (window.sanitizeCssProperty = aa, window.sanitizeCssSelectorList = ba, window.sanitizeStylesheet = da, window.sanitizeMediaQuery = Z); var fa, ga; (function () {
    function g(f, a, g, b, h) {
      for (var d = a++; a < g && '{' !== f[a] && ';' !== f[a]; ) ++a;
      if (a < g && (h || ';' === f[a])) {
        var h = d + 1,
        e = a;
        h < g && ' ' === f[h] && ++h;
    ...
    function w(f, a, i, b) {
      ...
      for (b.startBlock && b.startBlock(); a < i; ) {
        ...
        a = ' ' === h || ';' === h ? a + 1 : '@' === h ? g(f, a, i, b, C)  : '{' === h ? w(f, a, i, b)  : M(f, a, i, b)
      }
    ...
    function x(f, a, g, b) {
      for (var h, d = [
      ], e = - 1; a < g; ++a) if (h = f[a].charAt(0), '[' === h || '(' === h) d[++e] = h;
       else if (']' === h && '[' === d[e] || ')' === h && '(' === d[e]) --e;
       else if ('{' === h || '}' === h || ';' === h || '@' === h || ':' === h && !b) break;
      0 <=
      e && (a = ~(a + 1));
      return a
    }
    ...
    function e(f, a, g, b) {
      var h = f[a++];
      if (!v.test(h)) return E(f, a, g);
      a < g && ' ' === f[a] && ++a;
      if (a == g || ':' !== f[a]) return E(f, a, g);
      ++a;
      a < g && ' ' === f[a] && ++a;
      var d = x(f, a, g, C);
      if (0 > d) d = ~d;
    ...
    fa = function (f, a) {
      ...
      for (var b = 0, h = e.length; b < h; ) b = ' ' === e[b] ? b + 1 : b < h ? '@' === e[b].charAt(0) ? g(e, b, h, a, n)  : M(e, b, h, a)  : b;
      a.endStylesheet && a.endStylesheet()
    };
    var v = /^-?[a-z]/i;
    ga = function (g, a) {
      for (var i = U(g), b = 0, h = i.length; b < h; ) b = ' ' !== i[b] ? e(i, b, h, a)  : b + 1
    }
  }) (); 'undefined' !== typeof window && (window.parseCssStylesheet = fa, window.parseCssDeclarations = ga); var $ = {
    d: {
      NONE: 0,
      URI: 1,
      URI_FRAGMENT: 11,
  ...
  'undefined' !== typeof window && (window.html4 = $); var ha = function (g) {
    function w(a) {
      ...
      var b = a.match(q);
      return b ? String.fromCharCode(parseInt(b[1], 10))  : (b = a.match(B)) ? String.fromCharCode(parseInt(b[1], 16))  : r && F.test(a) ? (r.innerHTML = '&' + a + ';', b = r.textContent, k[a] = b)  : '&' + a + ';'
    }
    function M(a, b) {
      return w(b)
    }
    ...
    function v(b) {
      ...
      return function (b, g) {
        ...
        if (G) f = f.split(H);
          ...
          for (var e = [
          ], h = 0, j; (j = H.exec(f)) !== s; ) e.push(f.substring(h, j.index)),
          e.push(j[0]),
    ...
    function a(a, d, p, e, t) {
      try {
        a.H && 0 == p && a.H(t);
        for (var h, z, j, k = d.length; p < k; ) {
          var o = d[p++],
          l = d[p];
          switch (o) {
            case '&':
              I.test(l) ? (a.e && a.e('&' + l, t, A, f(a, d, p, e, t)), p++)  : a.e && a.e('&amp;', t, A, f(a, d, p, e, t));
              break;
            case '</':
              if (h = /^([-\w:]+)[^\'\"]*/.exec(l)) if (h[0].length === l.length && '>' === d[p + 1]) p += 2,
              j = h[1].toLowerCase(),
              a.t && a.t(j, t, A, f(a, d, p, e, t));
               else {
                var m = d,
                q = p,
                r = a,
                ...
                y = e,
                w = b(m, q);
                w ? (r.t && r.t(w.name, u, v, f(r, m, q, y, u)), p = w.next)  : p = m.length
              } else a.e && a.e('&lt;/', t, A, f(a, d, p, e, t));
              break;
            case '<':
              ...
              '>' === d[p + 1]) {
                ...
                v = e,
                x = b(m, p);
                x ? (q.w && q.w(x.name, x.R, r, u, f(q, m, x.next, v, r)), p = x.c & K ? i(m, x, q, r, u, v)  : x.next)  : p = m.length
              } else a.e && a.e('&lt;', t, A, f(a, d, p, e, t));
              break;
            case '<!--':
              if (!e.C) {
                for (z = p + 1; z < k && !('>' === d[z] && /--$/.test(d[z - 1])); z++);
                if (z < k) {
                  if (a.A) {
    ...
    function i(a, b, d, h, t, j) {
      var z = a.length;
      T.hasOwnProperty(b.name) || (T[b.name] = RegExp('^' + b.name + '(?:[\\s\\/]|$)', 'i'));
      for (var i = T[b.name], k = b.next, l = b.next + 1; l < z && !('</' === a[l - 1] && i.test(a[l])); l++);
      l < z && (l -= 1);
      z = a.slice(k, l).join('');
      if (b.c & g.c.CDATA) d.z && d.z(z, h, t, f(d, a, l, j, h));
       else if (b.c & g.c.RCDATA) d.F && d.F(e(z), h, t, f(d, a, l, j, h));
    ...
    function b(a, b) {
      ...
      if (!(j <= h)) {
        ...
        e; ) if (d = ja.exec(e)) if (d[4] && !d[5] || d[6] && !d[7]) {
          for (var d = d[4] || d[6], l = C, e = [
            e,
            a[h++]
          ]; h < j; h++) {
            if (l) {
              if ('>' === a[h]) break
            } else 0 <= a[h].indexOf(d) && (l = n);
            e.push(a[h])
          }
          if (j <= h) break;
          e = e.join('')
